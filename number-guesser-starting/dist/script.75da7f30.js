...
var generateTarget = function generateTarget() {
  return Math.floor(Math.random() * 10);
};

var compareGuesses = function compareGuesses(human, computer, target) {
  var humanDiff = Math.abs(target - human);
  var computerDiff = Math.abs(target - computer);
...
var updateScore = function updateScore(winner) {
  winner === 'human' ? humanScore += 1 : computerScore += 1;
};

var advanceRound = function advanceRound() {
