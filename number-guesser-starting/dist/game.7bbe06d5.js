...
guessButton.addEventListener('click', function () {
  ...
  target = generateTarget(); // Retrieve the player's guess

  var currentHumanGuess = humanGuessInput.value; // Make a random 'computer guess'

  var computerGuess = Math.floor(Math.random() * 10); // Display the computer guess and the target

  computerGuessDisplay.innerText = computerGuess;
  targetNumberDisplay.innerText = target; // Determine if the human or computer wins:

  var humanIsWinner = compareGuesses(currentHumanGuess, computerGuess, target);
  var winner = humanIsWinner ? 'human' : 'computer'; // Update the correct score:
  ...
  computerScoreDisplay.innerText = computerScore; // Set the correct disabled state for the buttons
...
nextRoundButton.addEventListener('click', function () {
  ...
  advanceRound(); // Display the new round number
...
},{}]},{},["../../../../../../opt/homebrew/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","game.js"], null)
